...
const ultimo = 100;
// Por último en cuanto a sonidos se refiere, añadimos un sonido para cuando perdamos
var perdiste = new Audio('simonFin.mp3');
// Añadimos un sonido para cuando se pulse un btón, aunque este aún no lo reproducimos
var sonBoton = new Audio('simon.mp3');
...
function elegirColor(ev) {
    ...
    if (numeroColor === secuencia[subnivel]) {
        ...
        perdiste.play();
        // He tenido que meter la puntuación dentro de un Time Out ya que estaba evitando que el sonido sonase hasta que quitabamos la alarma
        setTimeout(() => alert("Has conseguido " + puntuacion + " puntos!!"), 1000);
        terminarJuego();
        // También restablecemos la puntuacióna  0 para la próxima partida. También he tenido que meterla en un Time Out porque se reiniciaba antes de sonar la alarma y siempre salían 0 puntos
        setTimeout(() => puntuacion = 0, 1000);
